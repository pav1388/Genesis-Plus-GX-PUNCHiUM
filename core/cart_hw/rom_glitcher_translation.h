...
typedef enum {
    ...
    RG_TR_LIST_OF_FOUND,
    RG_TR_INSTRUCTION_FILTER,
    RG_TR_INSTRUCTION_ARITHMETIC,
    RG_TR_INSTRUCTION_BRANCHING,
    RG_TR_INSTRUCTION_SETTING,
    RG_TR_INSTRUCTION_LOOPING,
    RG_TR_STOP_GLITCHER,
    RG_TR_OPTIONS,
    RG_TR_SEARCH_HEADER,
    RG_TR_SAVE_STATE,
    RG_TR_HIDE_REPLAY_PROGRESS,
    RG_TR_PAUSE_EFFECT,
    RG_TR_PREV_PAGE,
    RG_TR_NEXT_PAGE,
    RG_TR_ON,
    ...
    RG_TR_DUPLICATE,
    RG_TR_GLITCH_SAVED_TO, // not used
